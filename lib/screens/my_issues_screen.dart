...
class _MyIssuesScreenState extends State<MyIssuesScreen> {
  ...
  Future<void> _loadIssues() async {
    ...
    // Fetching all issues (you can filter by currentUser.uid later if you want private lists)
  ...
  void _applyFilters() {
    ...
    setState(() {
      _filteredIssues = _allIssues.where((issue) {
        // Text Match
        final matchesSearch = issue.title.toLowerCase().contains(query) || 
  ...
  Color _getStatusColor(String status) {
    switch (status.toLowerCase()) {
      case 'reported': return const Color(0xFFF59E0B); // Orange
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          fit: StackFit.expand, // Locks the bottom nav in place
          children: [
            Column(
                ...
                Expanded(
                  child: _isLoading
                      ...
                      : _filteredIssues.isEmpty
                          ? Center(
                              child: Text('No reports match your filters.', style: GoogleFonts.inter(color: const Color(0xFF94A3B8), fontWeight: FontWeight.w500)),
                            )
                          : ListView.separated(
                              padding: const EdgeInsets.fromLTRB(24, 8, 24, 120), // Bottom padding for Nav Bar
                              physics: const BouncingScrollPhysics(),
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: const Color(0xFFF1F5F9)),
                                      // The magic offset solid shadow that matches your screenshot perfectly
                                      boxShadow: [
                                        BoxShadow(color: accentColor, offset: const Offset(-4, 6), blurRadius: 0),
                                      ],
                                    ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: const Icon(LucideIcons.mapPin, size: 24, color: Color(0xFFCBD5E1)),
                                        ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                ...
                                                style: GoogleFonts.spaceGrotesk(fontSize: 16, fontWeight: FontWeight.w900, color: const Color(0xFF0F172A), height: 1.1),
                                              ),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Text(
                                                      (issue.address ?? 'BANGALORE, KA').toUpperCase(),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(issue.status.toUpperCase(), style: GoogleFonts.spaceGrotesk(fontSize: 9, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: 0.5)),
                                                  ),
                                                  // Priority Text
                                                  Text(
                                                    '${issue.urgency.toUpperCase()} PRIORITY',
                                                    style: GoogleFonts.spaceGrotesk(fontSize: 10, fontWeight: FontWeight.w900, color: accentColor, letterSpacing: 0.5),
                                                  )
                                                ],
                                              )
                                            ],
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildNavItem(LucideIcons.list, 'MY ISSUES', true, () {}), // ACTIVE
